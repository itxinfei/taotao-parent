...
public class SendMail {
    ...
    public static void sendEmail(String subject, String text) throws MessagingException {
        ...
        //这里填你登录163邮箱所用的用户名
        msg.setFrom(new InternetAddress("17671787093@163.com")); //设置发件人，163邮箱要求发件人与登录用户必须一致（必填），其它邮箱不了解
        ...
        trans.connect("smtp.163.com", 25, "17671787093@163.com", "xxxxxxx"); //连接邮箱smtp服务器，25为默认端口
        //要发送到哪个邮箱，这里以qq邮箱为例
        trans.sendMessage(msg, new Address[]{new InternetAddress("747011882@qq.com")}); //发送邮件
    ...
    public static void groupSendEmail(String subject, String content) throws MessagingException {
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("17671787093@163.com", "xxxxxx");//163邮箱用户名和客户端授权密码（注意，不是登录密码）
            }
        });
        ...
        Message msg = new MimeMessage(session);
        //邮件发送者
        msg.setFrom(new InternetAddress("17671787093@163.com"));
